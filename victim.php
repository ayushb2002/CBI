    ...
    <div class="container-fluid bg-black">
        ...
        <div class="row text-white" id="welcomeBody">
            ...
            <div class="col-12 text-white text-center">
                ...
                <div class="mb-3">
                <input type="text" name="searchVictim" class="form-control m-3 px-3" placeholder="Search by Victim ID: " required>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                {
                    $sql1 = "SELECT V.* FROM victim V WHERE V.VictimID = '".$victim."'";
                    $sql2 = "SELECT P.* FROM victim V, person P WHERE P.Adhaar = V.Adhaar AND V.VictimID = '".$victim."'";
                        ...
                        $row2 = mysqli_fetch_assoc($result2);
                            ...
                            <div class="col-12 m-5 text-white text-center">
                                <div class="row">
                                    ...
                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Victim ID - <?php echo $row1["VictimID"]; ?></span>                                        
                                    </div>
                                    ...
                                    <div class="col-6 p-2 criminalDetails">
                                        <p>Concession - <?php echo $row1["Concession"]; ?></p>                                        
                                    </div>
