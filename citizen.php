    ...
    <div class="container-fluid bg-black">
        ...
        <div class="row text-white" id="welcomeBody">
            ...
            <div class="col-12 text-white text-center">
                ...
                <div class="mb-3">
                <input type="text" name="searchCitizen" class="form-control m-3" placeholder="Search Citizen by Adhaar: " required>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $citizen = $_REQUEST["searchCitizen"];
                ...
                {
                    $sql = "SELECT P.* FROm person P WHERE P.Adhaar = '".$citizen."'";
                        ...
                        $row = mysqli_fetch_assoc($result);
                            ...
                            <div class="col-12 m-5 text-white text-center">
                                <div class="row">
                                    ...
                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Adhaar - <?php echo $row["Adhaar"]; ?></span>                                        
                                    </div>
                                    ...
                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Qualification - <?php echo $row["Qualification"]; ?></span>                                        
                                    </div>
