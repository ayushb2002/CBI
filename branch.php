    ...
    <div class="container-fluid bg-black">
        ...
        <div class="row text-white" id="welcomeBody">
            <div class="col-12 text-center text-white">
                <h1>Branch Database</h1>
            </div>

            <div class="col-12 text-white text-center">
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                <div class="mb-3">
                <input type="text" name="searchBranch" class="form-control m-3" placeholder="Search branch by ID: " required>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                {
                    $sql = "SELECT B.* FROm branch B WHERE B.BranchID = '".$branch."'";
                            ...
                            <div class="col-12 m-5 text-white text-center">
                                <div class="row">
                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Branch ID - <?php echo $row["BranchID"]; ?></span>                                        
                                    </div>

                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Manager - <?php echo $row["Manager"]; ?></span>                                        
                                    </div>
                                    ...
                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Details - <?php echo $row["Details"]; ?></span>                                        
                                    </div>
