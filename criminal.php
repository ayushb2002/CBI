    ...
    <div class="container-fluid bg-black">
        ...
        <div class="row text-white" id="welcomeBody">
            ...
            <div class="col-12 text-white text-center">
                ...
                <div class="mb-3">
                <input type="text" name="searchCriminal" class="form-control m-3" placeholder="Search Criminal by ID: " required>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $criminal = $_REQUEST["searchCriminal"];
                ...
                {
                    $sql1 = "SELECT C.* FROm criminal C WHERE C.CriminalID = '".$criminal."'";
                    $sql2 = "SELECT P.* FROm criminal C, person P WHERE P.Adhaar = C.Adhaar AND C.CriminalID = '".$criminal."'";
                        ...
                        $row2 = mysqli_fetch_assoc($result2);
                            ...
                            <div class="col-12 m-5 text-white text-center">
                                <div class="row">
                                    ...
                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Criminal ID - <?php echo $row1["CriminalID"]; ?></span>                                        
                                    </div>

                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Crime ID - <?php echo $row1["CrimeID"]; ?></span>                                        
                                    </div>

                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Reward - Rs.<?php echo $row1["Reward"]; ?></span>                                        
                                    </div>

                                    <div class="col-6 p-2 criminalDetails">
                                        <span>Priority Status - <?php echo $row1["PriorityStatus"]; ?></span>                                        
                                    </div>
