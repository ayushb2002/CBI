...
{  
            if (isset($_GET["adhaar"]) || isset($_SESSION["adhaar"])) {
               ...
               // $sqlnew = "SELECT OfficerID FROM officer WHERE Adhaar='".$adhaar."'";
                ...
                $sql3 = "SELECT CriminalID FROM criminal ORDER BY CriminalID DESC LIMIT 1";
                ...
                if(mysqli_num_rows($result2) > 0 && mysqli_num_rows($result3) > 0)
                {
                    ...
                    $lastID = (int)trim($row3["CriminalID"], "CRIMINAL");
                    $newID = $lastID + 1;
                    $CriminalID = "CRIMINAL".(string)$newID;
                    ?>

<div class="col-12 m-5 text-white text-center">
                <div class="row">
                    <div class="col-12 p2">
                        <h2>Name of criminal - <?php echo $row2["Name"]; ?></h2>
                    </div>
                    <div class="col-12 p2">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="editProfile">
                            <div class="col-auto">
                                Criminal ID
                                <input type="text" name="criminalID" class="form-control criminalDetails" value="<?php echo $CriminalID; ?>"
                                    disabled>
                            </div>
                            <div class="col-auto">
                                Adhaar
                            ...
                            <div class="col-auto">
                                Reward
                                <input type="number" name="reward" class="form-control criminalDetails"  requi>
                            </div>
                            <div class="col-auto">
                                Crime ID
                                <input type="text" name="crimeID" class="form-control criminalDetails" placeholder="Enter Crime ID"
                                    required>
                            </div>
                            ...
                            <div class="col-auto">
                                Priority Status
                                <select name="prioritystatus" class="form-control criminalDetails" required>
            ...
            <?php
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $sql = "INSERT INTO `criminal`(`CriminalID`, `CrimeID`, `Adhaar`, `Reward`, `PriorityStatus`) VALUES ('".$CriminalID."', '".$_REQUEST["crimeID"]."','".$adhaar."', '".$_REQUEST["reward"]."','".$_REQUEST["prioritystatus"]."')";
            ...
            <div class="col-12 m-5 text-white text-center">
                <div class="row">
                    <div class="col-12">
                        <span class="alert alert-success" role="alert">Criminal Added!</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 m-5 text-white text-center">
                <div class="row">
                    <div class="col-12">
                        <span class="alert alert-warning" role="alert">Could not add Criminal!</span>
                    </div>
                </div>
            </div>
