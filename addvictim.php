    ...
    <div class="container-fluid bg-black">
        ...
        <div class="row text-white" id="welcomeBody">
            ...
            <div class="col-12 text-white text-center">
                <form method="GET" action="askvictimdetails.php">
                    <div class="mb-3">
                        <input type="text" name="adhaar" class="form-control m-3" placeholder="Enter Victim Adhaar: "
                            required>
